...
__all__ = [
    'TEST_SETTINGS', 'SEMITEMP_DIR', 'TEMP_DIR', 'TEST_DATA_DIR', 'TEST_DATA_DEMO', 'TEST_GT_DIR',
    'TASK_NAMES', 'FTASK_NAMES', 'TASK_NAME_MAPPING', 'DATASET_SETTINGS', 'DECOMP_SETTINGS',
    'LOS_SETTINGS', 'PHENOT_SETTINGS', 'IHM_SETTINGS'
]
